...
import com.example.trello.misc.AppTheme
            ...
            text = {
                Column(
                    ...
                    val list = mutableListOf(
                        AppTheme("0","За замовчуванням",false, R.drawable.ic_phone),
                        AppTheme("1","Світла",false,R.drawable.ic_light),
                        AppTheme("2","Темна",false,R.drawable.ic_dark)
                    )
